...
subbandSize = [10 4 2];    % must be > 1 
numSubbands =[20 50 100] ;    % numSubbands*subbandSize <= numFFT
...
prototypeFilterInv = 1./prototypeFilterFreq(numFFT/2-subbandSize(sloop)/2+(1:subbandSize(sloop)));
...
xlabel('SNR')
ylabel('BER')
title('BER vs SNR for UFMC QAM Modulation')
end