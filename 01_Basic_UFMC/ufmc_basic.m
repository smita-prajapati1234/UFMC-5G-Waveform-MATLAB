...
subbandOffset = 56; % numFFT/2-subbandSize*numSubbands/2 for band center
...
% ricianChan = comm.RicianChannel(KFactor=1,MaximumDopplerShift=0);
rayChan1 = comm.RayleighChannel('SampleRate',1e5,...
               'MaximumDopplerShift',130); % Rayleigh fading channel object

bitsPerSubCarrier = 3;   % 2: 4QAM, 4: 16QAM, 6: 64QAM, 8: 256QAM
% QAM Symbol mapper
...
ber1(loop)=ber(1);
disp(['UFMC Reception, BER = ' num2str(ber1) ' at SNR = ' ...
