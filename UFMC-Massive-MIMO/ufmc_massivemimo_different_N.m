...
subbandOffset = 156   %212%156; % numFFT/2-subbandSize*numSubbands/2 for band center
...
ber1(loop)=ber(1);
%MIMO(loop) = MIMO(loop) + log2(abs(det(eye(N(loop))+snrdB*H*H'/M)));
